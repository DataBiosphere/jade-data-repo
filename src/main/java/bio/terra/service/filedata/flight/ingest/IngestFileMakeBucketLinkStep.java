...
public class IngestFileMakeBucketLinkStep implements Step {
    ...
    public StepResult undoStep(FlightContext context) {
        // Parallel threads can try create the bucket link. We do not error on a duplicate create attempt.
        // Therefore, we do not delete the link during undo. Instead, we use a counter on the bucket link
