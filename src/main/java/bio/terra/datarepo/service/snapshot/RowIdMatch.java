 ...
 *
 * <ol>
 *   <li>A list of the input values that matched
 *   <li>A parallel list of the corresponding row ids of the matches
 *   <li>A list of the input values that did not match
 * </ol>
 *
 * This can be converted to a model to return when there are errors with the input values.
 */
