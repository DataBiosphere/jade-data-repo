...
public class RepositoryConfigurationModel {
  ...
  public RepositoryConfigurationModel clientId(String clientId) {
    this.clientId = clientId;
    return this;
  }

   /**
   * the google defined client id for the repository
   * @return clientId
  **/
  @ApiModelProperty(value = "the google defined client id for the repository")
  ...
  public RepositoryConfigurationModel activeProfiles(List<String> activeProfiles) {
    this.activeProfiles = activeProfiles;
    return this;
  }

  public RepositoryConfigurationModel addActiveProfilesItem(String activeProfilesItem) {
   ...
   /**
   * the active profiles for this instance
   * @return activeProfiles
  **/
  @ApiModelProperty(value = "the active profiles for this instance")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    RepositoryConfigurationModel repositoryConfigurationModel = (RepositoryConfigurationModel) o;
    return Objects.equals(this.clientId, repositoryConfigurationModel.clientId) &&
        Objects.equals(this.activeProfiles, repositoryConfigurationModel.activeProfiles);
  }

  @Override
  public int hashCode() {
    return Objects.hash(clientId, activeProfiles);
  }
  ...
  public String toString() {
    ...
    sb.append("class RepositoryConfigurationModel {\n");
