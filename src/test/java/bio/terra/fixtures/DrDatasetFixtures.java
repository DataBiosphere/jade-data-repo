...
import bio.terra.model.DrDatasetSpecificationModel;
...
public final class DrDatasetFixtures {
    private DrDatasetFixtures() {
    }

    public static DrDatasetSummaryModel buildMinimalDatasetSummary() {
    ...
    public static DrDatasetSpecificationModel buildSchema()  {
    ...
    public static DrDatasetRequestModel buildDatasetRequest() {
        return new DrDatasetRequestModel()
            .name("Minimal")
            .description("This is a sample dataset definition")
            .schema(buildSchema());
    }
