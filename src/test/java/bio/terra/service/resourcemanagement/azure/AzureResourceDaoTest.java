...
public class AzureResourceDaoTest {
    ...
    public void setup() throws IOException, InterruptedException {
        ...
        var appDeployment =
            ResourceFixtures.randomApplicationDeploymentResource(billingProfile);
        ...
        var sa1 = azureResourceDao.createAndLockStorageAccount(
        ...
        var sa2 = azureResourceDao.createAndLockStorageAccount(
    ...
    public void oneApplicationOneBillingProfilesTwoStorageAccounts() throws Exception {
        ...
        assertThat(
            ...
            azureResourceDao.retrieveApplicationDeploymentByName(
