 ...
 */
@ApiModel(description = "The datasource identifies the dataset and asset from which to source the data. ")
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2020-09-25T14:51:02.312-04:00")
public class SnapshotRequestAssetModel {
  @JsonProperty("assetName")
  private String assetName = null;

  @JsonProperty("rootValues")
  private List<String> rootValues = new ArrayList<>();

  public SnapshotRequestAssetModel assetName(String assetName) {
  ...
  **/
  ...
  public SnapshotRequestAssetModel rootValues(List<String> rootValues) {
    this.rootValues = rootValues;
    return this;
  }

  public SnapshotRequestAssetModel addRootValuesItem(String rootValuesItem) {
    this.rootValues.add(rootValuesItem);
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    SnapshotRequestAssetModel snapshotRequestAssetModel = (SnapshotRequestAssetModel) o;
    return Objects.equals(this.assetName, snapshotRequestAssetModel.assetName) &&
        Objects.equals(this.rootValues, snapshotRequestAssetModel.rootValues);
  }

  @Override
  public int hashCode() {
    return Objects.hash(assetName, rootValues);
  }
  ...
  public String toString() {
    ...
    sb.append("class SnapshotRequestAssetModel {\n");
    
    sb.append("    assetName: ").append(toIndentedString(assetName)).append("\n");
    sb.append("    rootValues: ").append(toIndentedString(rootValues)).append("\n");
    sb.append("}");
    return sb.toString();
  }
