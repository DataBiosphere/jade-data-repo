 ...
 */
@ApiModel(description = "The total number of datasets available that match the filter criteria and a page of summaries ")
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2020-09-25T14:51:02.312-04:00")
public class EnumerateDatasetModel {
  @JsonProperty("total")
  private Integer total = null;

  @JsonProperty("items")
  private List<DatasetSummaryModel> items = null;

  public EnumerateDatasetModel total(Integer total) {
    this.total = total;
    return this;
  }
   ...
   * @return total
  **/
  @ApiModelProperty(value = "Total number of datasets")
  ...
  public EnumerateDatasetModel items(List<DatasetSummaryModel> items) {
    this.items = items;
    return this;
  }

  public EnumerateDatasetModel addItemsItem(DatasetSummaryModel itemsItem) {
    if (this.items == null) {
  ...
  **/
  ...
  public List<DatasetSummaryModel> getItems() {
    return items;
  }

  public void setItems(List<DatasetSummaryModel> items) {
    this.items = items;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EnumerateDatasetModel enumerateDatasetModel = (EnumerateDatasetModel) o;
    return Objects.equals(this.total, enumerateDatasetModel.total) &&
        Objects.equals(this.items, enumerateDatasetModel.items);
  }
  ...
  public String toString() {
    ...
    sb.append("class EnumerateDatasetModel {\n");
