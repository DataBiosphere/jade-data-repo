...
public class BulkLoadArrayResultModel {
  @JsonProperty("loadSummary")
  private BulkLoadResultModel loadSummary = null;

  @JsonProperty("loadFileResults")
  private List<BulkLoadFileResultModel> loadFileResults = null;

  public BulkLoadArrayResultModel loadSummary(BulkLoadResultModel loadSummary) {
  ...
  **/
  ...
  public BulkLoadResultModel getLoadSummary() {
    return loadSummary;
  }

  public void setLoadSummary(BulkLoadResultModel loadSummary) {
    this.loadSummary = loadSummary;
  }

  public BulkLoadArrayResultModel loadFileResults(List<BulkLoadFileResultModel> loadFileResults) {
    this.loadFileResults = loadFileResults;
    return this;
  }

  public BulkLoadArrayResultModel addLoadFileResultsItem(BulkLoadFileResultModel loadFileResultsItem) {
    if (this.loadFileResults == null) {
      this.loadFileResults = new ArrayList<>();
    }
    this.loadFileResults.add(loadFileResultsItem);
    return this;
  }

   /**
   * Get loadFileResults
   * @return loadFileResults
  **/
  @ApiModelProperty(value = "")
  public List<BulkLoadFileResultModel> getLoadFileResults() {
    return loadFileResults;
  }

  public void setLoadFileResults(List<BulkLoadFileResultModel> loadFileResults) {
    this.loadFileResults = loadFileResults;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    BulkLoadArrayResultModel bulkLoadArrayResultModel = (BulkLoadArrayResultModel) o;
    return Objects.equals(this.loadSummary, bulkLoadArrayResultModel.loadSummary) &&
        Objects.equals(this.loadFileResults, bulkLoadArrayResultModel.loadFileResults);
  }

  @Override
  public int hashCode() {
    return Objects.hash(loadSummary, loadFileResults);
  }
  ...
  public String toString() {
    ...
    sb.append("class BulkLoadArrayResultModel {\n");
    
    sb.append("    loadSummary: ").append(toIndentedString(loadSummary)).append("\n");
    sb.append("    loadFileResults: ").append(toIndentedString(loadFileResults)).append("\n");
    sb.append("}");
    return sb.toString();
  }
