...
/**
 * API tests for UnauthenticatedApi
 */
@Ignore
public class UnauthenticatedApiTest {

    private final UnauthenticatedApi api = new UnauthenticatedApi();
     ...
     */
    @Test
    public void retrieveRepositoryConfigTest() throws ApiException {
        RepositoryConfigurationModel response = api.retrieveRepositoryConfig();
     ...
     */
    @Test
    public void shutdownRequestTest() throws ApiException {
        api.shutdownRequest();
