...
public class CreateDatasetCreateIngestServiceAccountStep implements Step {
  ...
  public StepResult doStep(FlightContext context) throws InterruptedException {
    ...
    try {
      serviceAccount =
          resourceService.createDatasetServiceAccount(
              profileModel, projectId, datasetRequestModel.getName());
    ...
    workingMap.put(DatasetWorkingMapKeys.PROJECT_SERVICE_ACCOUNT, serviceAccount);
