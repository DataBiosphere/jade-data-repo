  ...
  void generateQuery() {
    ...
    var expected =
        """
            ...
            WHERE (c.concept_id_1 IN (SELECT c2.ancestor_concept_id
                  FROM concept_ancestor AS c2
                  WHERE (c2.descendant_concept_id = 1 AND c2.ancestor_concept_id != 1)) AND
              c.relationship_id = 'Subsumes' AND c1.standard_concept = 'S' AND c0.standard_concept = 'S')""";
    assertThat(
