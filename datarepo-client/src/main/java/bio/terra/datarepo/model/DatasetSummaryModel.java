...
public class DatasetSummaryModel {
  ...
  public DatasetSummaryModel id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public DatasetSummaryModel name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public DatasetSummaryModel description(String description) {
  ...
  **/
  ...
  public DatasetSummaryModel defaultProfileId(String defaultProfileId) {
  ...
  **/
  @ApiModelProperty(value = "This is the ID of the profile used for core dataset resources")
  ...
  public DatasetSummaryModel additionalProfileIds(List<String> additionalProfileIds) {
    this.additionalProfileIds = additionalProfileIds;
    return this;
  }

  public DatasetSummaryModel addAdditionalProfileIdsItem(String additionalProfileIdsItem) {
  ...
  **/
  ...
  public DatasetSummaryModel createdDate(String createdDate) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DatasetSummaryModel datasetSummaryModel = (DatasetSummaryModel) o;
    return Objects.equals(this.id, datasetSummaryModel.id) &&
        Objects.equals(this.name, datasetSummaryModel.name) &&
        Objects.equals(this.description, datasetSummaryModel.description) &&
        Objects.equals(this.defaultProfileId, datasetSummaryModel.defaultProfileId) &&
        Objects.equals(this.additionalProfileIds, datasetSummaryModel.additionalProfileIds) &&
        Objects.equals(this.createdDate, datasetSummaryModel.createdDate);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, description, defaultProfileId, additionalProfileIds, createdDate);
  }
  ...
  public String toString() {
    ...
    sb.append("class DatasetSummaryModel {\n");
