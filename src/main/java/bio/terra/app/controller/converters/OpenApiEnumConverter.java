...
/**
 * An abstract Spring Converter to convert from strings to Enum values generated by OpenAPI.
 * We define enumerated values in OpenAPI in lower-case, but we want to be able to parse upper or mixed-case
 * values supplied by the user. We also want to be able to return pretty error messages.
 *
 * This could probably be used for more than just Enums
...
public abstract class OpenApiEnumConverter<T> implements Converter<String, T> {
    ...
    public T convert(String source) {
        ...
        if (result == null) {
            throw new ValidationException(String.format("Invalid enum parameter: '%s'.", source),
