...
public abstract class CloudPlatformWrapper {
    ...
    abstract public void ensureValidRegion(String region, Errors errors);

    void ensureValidRegion(CloudPlatform platform,
                           String region,
    ...
    public abstract List<? extends StorageResource<?,?>> createStorageResourceValues(DatasetRequestModel datasetRequest);

    public abstract GoogleRegion getRegionFromDatasetRequestModel(DatasetRequestModel datasetRequestModel);
    ...
    static class GcpPlatform extends CloudPlatformWrapper {
        ...
        @Override
        public List<? extends StorageResource<?, ?>> createStorageResourceValues(DatasetRequestModel datasetRequest) {
            final GoogleRegion region = getRegionFromDatasetRequestModel(datasetRequest);
        ...
        @Override
        public GoogleRegion getRegionFromDatasetRequestModel(DatasetRequestModel datasetRequestModel) {
