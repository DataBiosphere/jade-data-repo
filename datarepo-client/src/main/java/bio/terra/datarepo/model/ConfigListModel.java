 ...
 */
@ApiModel(description = "Result list of configuration settings")
...
public class ConfigListModel {
  ...
  @JsonProperty("items")
  private List<ConfigModel> items = null;

  public ConfigListModel total(Integer total) {
    this.total = total;
    return this;
  }
   ...
   * @return total
  **/
  @ApiModelProperty(value = "Total number of configs")
  ...
  public ConfigListModel items(List<ConfigModel> items) {
    this.items = items;
    return this;
  }

  public ConfigListModel addItemsItem(ConfigModel itemsItem) {
    if (this.items == null) {
  ...
  **/
  ...
  public List<ConfigModel> getItems() {
    return items;
  }

  public void setItems(List<ConfigModel> items) {
    this.items = items;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ConfigListModel configListModel = (ConfigListModel) o;
    return Objects.equals(this.total, configListModel.total) &&
        Objects.equals(this.items, configListModel.items);
  }
  ...
  public String toString() {
    ...
    sb.append("class ConfigListModel {\n");
