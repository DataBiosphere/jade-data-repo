...
public class DatasetDataDeleteFlight extends Flight {
    ...
    public DatasetDataDeleteFlight(FlightMap inputParameters, Object applicationContext) {
        ...
        RetryRuleRandomBackoff lockingRetry = new RetryRuleRandomBackoff(500, appConfig.getMaxStairwayThreads(), 5);
        ...
        addStep(new LockDatasetStep(datasetDao, UUID.fromString(datasetId), false, configService), lockingRetry);
