...
public class IngestFileGetProjectStep implements Step {
    ...
    public IngestFileGetProjectStep(ResourceService resourceService,
                                    Dataset dataset,
    ...
    public StepResult doStep(FlightContext context) {
        ...
        final GoogleProjectResource datasetProject = resourceService.getProjectResource(dataset.getProjectResourceId());
        String sourceDatasetGoogleProjectId = datasetProject.getGoogleProjectId();
        String projectId = dataLocationSelector.projectIdForFile(dataset, sourceDatasetGoogleProjectId, billingProfile);
