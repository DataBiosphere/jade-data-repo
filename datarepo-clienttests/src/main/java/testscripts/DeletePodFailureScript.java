...
// I think it was overkill b/c it's really the same as a testScript, but it is a bit less user friendly
//
...
public class DeletePodFailureScript extends TestScript {
  private static final Logger logger = LoggerFactory.getLogger(DeletePodFailureScript.class);
