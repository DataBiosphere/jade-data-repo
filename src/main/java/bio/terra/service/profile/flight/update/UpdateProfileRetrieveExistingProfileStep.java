...
public class UpdateProfileRetrieveExistingProfileStep implements Step {
    ...
    private static final Logger logger = LoggerFactory.getLogger(UpdateProfileRetrieveExistingProfileStep.class);

    public UpdateProfileRetrieveExistingProfileStep(ProfileService profileService,
