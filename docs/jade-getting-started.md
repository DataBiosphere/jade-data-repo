...
# Setting for credentials to test on Azure - these files are populated in the render_configs.sh script
# Defaults to dev; You can switch to integration by running `./scripts/render_configs.sh -a integration`
