 ...
 */
@ApiModel(description = "The value of the parameter")
...
public class ConfigParameterModel {
  ...
  public ConfigParameterModel value(String value) {
    this.value = value;
    return this;
  }

   /**
   * Configuration parameters are always passed as strings and converted within the service. That keeps the JSON simple. Sending in specific types doesn&#39;t help much, because there still might be a mismatch between the type passed in and the type required. 
   * @return value
  **/
  @ApiModelProperty(value = "Configuration parameters are always passed as strings and converted within the service. That keeps the JSON simple. Sending in specific types doesn't help much, because there still might be a mismatch between the type passed in and the type required. ")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ConfigParameterModel configParameterModel = (ConfigParameterModel) o;
    return Objects.equals(this.value, configParameterModel.value);
  }
  ...
  public String toString() {
    ...
    sb.append("class ConfigParameterModel {\n");
