...
public class CreateSnapshotByRequestParquetFilesAzureStep extends CreateSnapshotParquetFilesAzureStep
  ...
  public CreateSnapshotByRequestParquetFilesAzureStep(AzureSynapsePdao azureSynapsePdao, SnapshotDao snapshotDao, SnapshotService snapshotService, DatasetService datasetService, AuthenticatedUserRequest userReq) {
  ...
  public StepResult doStep(FlightContext context) throws InterruptedException {
    SnapshotRequestModel snapshotReq = context.getWorkingMap().get(SnapshotWorkingMapKeys.BY_QUERY_SNAPSHOT_REQUEST_MODEL, SnapshotRequestModel.class);
  ...
  public StepResult createSnapshotPrimaryData(
    ...
    SnapshotRequestModel snapshotReq = workingMap.get(SnapshotWorkingMapKeys.BY_QUERY_SNAPSHOT_REQUEST_MODEL, SnapshotRequestModel.class);
    try {
