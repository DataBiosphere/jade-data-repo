...
public class SnapshotCreateFlightTest {
  ...
  void testSnapshotCreateFlight() {
    ...
    List<LockDatasetStep> lockDatasetSteps =
        FlightTestUtils.getStepsWithClass(flight, LockDatasetStep.class);
    assertThat(lockDatasetSteps, hasSize(1));
    LockDatasetStep lockDatasetStep = lockDatasetSteps.get(0);
    assertThat(
    ...
    List<UnlockDatasetStep> unlockDatasetSteps =
        FlightTestUtils.getStepsWithClass(flight, UnlockDatasetStep.class);
    assertThat(unlockDatasetSteps, hasSize(1));
    UnlockDatasetStep unlockDatasetStep = unlockDatasetSteps.get(0);
    assertThat(
