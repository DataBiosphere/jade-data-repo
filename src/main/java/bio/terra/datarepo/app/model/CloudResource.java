...
public interface CloudResource {
  ...
  class CloudResourceDeserializer extends StdDeserializer<CloudResource> {
    ...
    @Override
    public CloudResource deserialize(JsonParser jsonParser, DeserializationContext ctxt)
        throws IOException {
      ...
      if (!node.isTextual()) {
        throw new InvalidFormatException(
            jsonParser, "Invalid representation of CloudResource", node, CloudResource.class);
      }
