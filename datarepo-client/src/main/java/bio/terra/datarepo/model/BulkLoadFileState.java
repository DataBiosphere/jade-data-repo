...
/**
 * Gets or Sets BulkLoadFileState
 */
public enum BulkLoadFileState {
  ...
  BulkLoadFileState(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static BulkLoadFileState fromValue(String text) {
    for (BulkLoadFileState b : BulkLoadFileState.values()) {
