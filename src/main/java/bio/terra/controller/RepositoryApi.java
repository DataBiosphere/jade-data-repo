...
@javax.annotation.Generated(value = "io.swagger.codegen.languages.SpringCodegen", date = "2019-02-12T13:42:31.190-05:00")
...
public interface RepositoryApi {
    ...
    @RequestMapping(value = "/api/repository/v1/jobs",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    default ResponseEntity<List<JobModel>> enumerateJobs(@ApiParam(value = "The number of items to skip before starting to collect the result set.", defaultValue = "0") @Valid @RequestParam(value = "offset", required = false, defaultValue="0") Integer offset,@ApiParam(value = "The numbers of items to return.", defaultValue = "10") @Valid @RequestParam(value = "limit", required = false, defaultValue="10") Integer limit) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
                    return new ResponseEntity<>(getObjectMapper().get().readValue("[ {  \"job_status\" : \"running\",  \"status_code\" : 0,  \"submitted\" : \"submitted\",  \"description\" : \"description\",  \"id\" : { },  \"completed\" : \"completed\"}, {  \"job_status\" : \"running\",  \"status_code\" : 0,  \"submitted\" : \"submitted\",  \"description\" : \"description\",  \"id\" : { },  \"completed\" : \"completed\"} ]", List.class), HttpStatus.NOT_IMPLEMENTED);
                } catch (IOException e) {
                    log.error("Couldn't serialize response for content type application/json", e);
                    return new ResponseEntity<>(HttpStatus.INTERNAL_SERVER_ERROR);
                }
    ...
    @ApiOperation(value = "", nickname = "retrieveJob", notes = "Retrieve a job's status by id", response = JobModel.class, tags={ "repository", })
    @ApiResponses(value = { 
    ...
    @RequestMapping(value = "/api/repository/v1/jobs/{id}",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    default ResponseEntity<JobModel> retrieveJob(@ApiParam(value = "A study or dataset id",required=true) @PathVariable("id") String id) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
                    return new ResponseEntity<>(getObjectMapper().get().readValue("{  \"job_status\" : \"running\",  \"status_code\" : 0,  \"submitted\" : \"submitted\",  \"description\" : \"description\",  \"id\" : { },  \"completed\" : \"completed\"}", JobModel.class), HttpStatus.NOT_IMPLEMENTED);
                } catch (IOException e) {
                    log.error("Couldn't serialize response for content type application/json", e);
                    return new ResponseEntity<>(HttpStatus.INTERNAL_SERVER_ERROR);
                }
    ...
    @ApiOperation(value = "", nickname = "retrieveJobResult", notes = "Retrieve a job's result by id", response = Object.class, tags={ "repository", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "", response = Object.class) })
    @RequestMapping(value = "/api/repository/v1/jobs/{id}/result",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    default ResponseEntity<Object> retrieveJobResult(@ApiParam(value = "A study or dataset id",required=true) @PathVariable("id") String id) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
