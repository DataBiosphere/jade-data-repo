 ...
 */
@ApiModel(description = "Identifies the list of tables + columns along with the row ids to be included in the snapshot ")
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2020-09-25T14:51:02.312-04:00")
public class SnapshotRequestRowIdModel {
  @JsonProperty("tables")
  private List<SnapshotRequestRowIdTableModel> tables = new ArrayList<>();

  public SnapshotRequestRowIdModel tables(List<SnapshotRequestRowIdTableModel> tables) {
    this.tables = tables;
    return this;
  }

  public SnapshotRequestRowIdModel addTablesItem(SnapshotRequestRowIdTableModel tablesItem) {
  ...
  **/
  ...
  public List<SnapshotRequestRowIdTableModel> getTables() {
    return tables;
  }

  public void setTables(List<SnapshotRequestRowIdTableModel> tables) {
    this.tables = tables;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    SnapshotRequestRowIdModel snapshotRequestRowIdModel = (SnapshotRequestRowIdModel) o;
    return Objects.equals(this.tables, snapshotRequestRowIdModel.tables);
  }
  ...
  public String toString() {
    ...
    sb.append("class SnapshotRequestRowIdModel {\n");
