...
public class CreateDatasetCreateStorageAccountLinkStep implements Step {
    private static Logger logger = LoggerFactory.getLogger(CreateDatasetCreateStorageAccountLinkStep.class);
    private final DatasetStorageAccountDao datasetStorageAccountDao;
    private final DatasetRequestModel datasetRequestModel;

    public CreateDatasetCreateStorageAccountLinkStep(DatasetStorageAccountDao datasetStorageAccountDao,
