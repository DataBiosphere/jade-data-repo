...
/**
 * The {@code DRSpan} is a singleton class, which is the default {@link Span} that is used when
 ...
 */
@Immutable
public final class DRSpan extends Span {
    /**
     * Singleton instance of this class.
     *
     * @since 0.5
     */
    private static final Logger logger = LoggerFactory.getLogger(DRSpan.class);
    public static final DRSpan INSTANCE = new DRSpan();
    ...
    public void addAnnotation(String description, Map<String, AttributeValue> attributes) {
        ...
        Utils.checkNotNull(attributes, "attributes");
        logger.info("Tracer - {}, attributes: {}", description, attributes);
    }
