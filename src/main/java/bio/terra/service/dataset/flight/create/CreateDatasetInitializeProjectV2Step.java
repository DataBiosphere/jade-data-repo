...
/** The step is only meant to be invoked for GCP backed datasets where billing lives in rawls */
public class CreateDatasetInitializeProjectV2Step implements Step {
  private final ResourceService resourceService;
  private final DatasetRequestModel datasetRequestModel;

  public CreateDatasetInitializeProjectV2Step(
  ...
  public StepResult doStep(FlightContext context) throws InterruptedException {
    ...
    UUID billingProfileId = datasetRequestModel.getDefaultProfileId();
    ...
    try {
      projectResourceId =
          resourceService.getOrCreateDatasetProjectV2(
              billingProfileId, projectId, region, datasetRequestModel.getName(), datasetId);
