...
public class LookupSnapshot extends runner.TestScript {
  ...
  private SnapshoSummaryModel snapshoSummaryModel;
  ...
  public void setup(Map<String, ApiClient> apiClients) throws Exception {
    ...
    // do I need to load in data here?
  ...
  public void userJourney(ApiClient apiClient) throws Exception {
    RepositoryApi repositoryApi = new RepositoryApi(apiClient);
      ...
      SnapshotModel snapshotModel = repositoryApi.retrieveSnapshot(snapshoSummaryModel.getId());
