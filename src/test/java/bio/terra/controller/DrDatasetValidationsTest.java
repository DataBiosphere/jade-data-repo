...
import static bio.terra.fixtures.DrDatasetFixtures.buildAsset;
import static bio.terra.fixtures.DrDatasetFixtures.buildAssetParticipantTable;
import static bio.terra.fixtures.DrDatasetFixtures.buildAssetSampleTable;
import static bio.terra.fixtures.DrDatasetFixtures.buildParticipantSampleRelationship;
import static bio.terra.fixtures.DrDatasetFixtures.buildSampleTerm;
...
@Category(Unit.class)
public class DrDatasetValidationsTest {
    ...
    private ErrorModel expectBadDatasetCreateRequest(DrDatasetRequestModel datasetRequest) throws Exception {
    ...
    public void testDatasetNameInvalid() throws Exception {
        ...
        checkValidationErrorModel("datasetNameInvalid", errorModel, new String[]{"DrDatasetNameInvalid"});
    ...
    public void testDatasetNameMissing() throws Exception {
        ...
        checkValidationErrorModel("datasetNameMissing", errorModel,
            new String[]{"NotNull", "DrDatasetNameMissing"});
    }
