...
import bio.terra.service.snapshotbuilder.query.CellValue;
import bio.terra.service.snapshotbuilder.query.ColumnHeaderSchema;
...
class ColumnHeaderSchemaTest {
  ...
  void getIndexNotFound() {
    ...
    String name = "dddd";
    var thrown =
        assertThrows(IllegalArgumentException.class, () -> columnHeaderSchema.getIndex(name));
