...
public class RelationshipDao {
    ...
    // part of a transaction propagated from DrDatasetDao
    public void createDatasetRelationships(DrDataset dataset) {
        for (DrDatasetRelationship rel : dataset.getRelationships()) {
            create(rel);
        }
    }

    protected void create(DrDatasetRelationship datasetRelationship) {
    ...
    public void retrieve(DrDataset dataset) {
        ...
        dataset.relationships(retrieveDatasetRelationships(columnIds, dataset.getTablesById(),
            dataset.getAllColumnsById()));
    }

    private List<DrDatasetRelationship> retrieveDatasetRelationships(
            List<UUID> columnIds,
