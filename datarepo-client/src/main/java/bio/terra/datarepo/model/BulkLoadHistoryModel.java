...
public class BulkLoadHistoryModel {
  ...
  @JsonProperty("checksumCRC")
  private String checksumCRC = null;
  ...
  public BulkLoadHistoryModel sourcePath(String sourcePath) {
  ...
  **/
  ...
  public BulkLoadHistoryModel targetPath(String targetPath) {
  ...
  **/
  ...
  public BulkLoadHistoryModel state(BulkLoadFileState state) {
    this.state = state;
    return this;
  }
  ...
  **/
  ...
  public BulkLoadHistoryModel fileId(String fileId) {
    this.fileId = fileId;
    return this;
  }
  ...
  **/
  ...
  public BulkLoadHistoryModel checksumCRC(String checksumCRC) {
    this.checksumCRC = checksumCRC;
    return this;
  }

   /**
   * The checksum crc of the loaded file; non-null if state is SUCCEEDED
   * @return checksumCRC
  **/
  @ApiModelProperty(value = "The checksum crc of the loaded file; non-null if state is SUCCEEDED")
  public String getChecksumCRC() {
    return checksumCRC;
  }

  public void setChecksumCRC(String checksumCRC) {
    this.checksumCRC = checksumCRC;
  }

  public BulkLoadHistoryModel checksumMD5(String checksumMD5) {
    this.checksumMD5 = checksumMD5;
    return this;
  }

   /**
   * The checksum mD5 of the loaded file; non-null if state is SUCCEEDED
   * @return checksumMD5
  **/
  @ApiModelProperty(value = "The checksum mD5 of the loaded file; non-null if state is SUCCEEDED")
  ...
  public BulkLoadHistoryModel error(String error) {
    this.error = error;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    BulkLoadHistoryModel bulkLoadHistoryModel = (BulkLoadHistoryModel) o;
    return Objects.equals(this.sourcePath, bulkLoadHistoryModel.sourcePath) &&
        Objects.equals(this.targetPath, bulkLoadHistoryModel.targetPath) &&
        Objects.equals(this.state, bulkLoadHistoryModel.state) &&
        Objects.equals(this.fileId, bulkLoadHistoryModel.fileId) &&
        Objects.equals(this.checksumCRC, bulkLoadHistoryModel.checksumCRC) &&
        Objects.equals(this.checksumMD5, bulkLoadHistoryModel.checksumMD5) &&
        Objects.equals(this.error, bulkLoadHistoryModel.error);
  }

  @Override
  public int hashCode() {
    return Objects.hash(sourcePath, targetPath, state, fileId, checksumCRC, checksumMD5, error);
  }
  ...
  public String toString() {
    ...
    sb.append("class BulkLoadHistoryModel {\n");
    ...
    sb.append("    checksumCRC: ").append(toIndentedString(checksumCRC)).append("\n");
