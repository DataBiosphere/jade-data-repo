 ...
 */
@ApiModel(description = "The total number of snapshots available that match the criteria and a page of summaries ")
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2020-09-25T14:51:02.312-04:00")
public class EnumerateSnapshotModel {
  @JsonProperty("total")
  private Integer total = null;

  @JsonProperty("items")
  private List<SnapshotSummaryModel> items = null;

  public EnumerateSnapshotModel total(Integer total) {
    this.total = total;
    return this;
  }
   ...
   * @return total
  **/
  @ApiModelProperty(value = "Total number of snapshots")
  ...
  public EnumerateSnapshotModel items(List<SnapshotSummaryModel> items) {
    this.items = items;
    return this;
  }

  public EnumerateSnapshotModel addItemsItem(SnapshotSummaryModel itemsItem) {
    if (this.items == null) {
  ...
  **/
  ...
  public List<SnapshotSummaryModel> getItems() {
    return items;
  }

  public void setItems(List<SnapshotSummaryModel> items) {
    this.items = items;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EnumerateSnapshotModel enumerateSnapshotModel = (EnumerateSnapshotModel) o;
    return Objects.equals(this.total, enumerateSnapshotModel.total) &&
        Objects.equals(this.items, enumerateSnapshotModel.items);
  }
  ...
  public String toString() {
    ...
    sb.append("class EnumerateSnapshotModel {\n");
