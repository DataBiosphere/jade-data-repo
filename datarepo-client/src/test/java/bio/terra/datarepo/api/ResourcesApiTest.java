...
public class ResourcesApiTest {
    ...
    public void createProfileTest() throws ApiException {
        BillingProfileRequestModel billingProfileRequest = null;
        BillingProfileModel response = api.createProfile(billingProfileRequest);
    ...
    public void deleteProfileTest() throws ApiException {
        String id = null;
        DeleteResponseModel response = api.deleteProfile(id);
     ...
     */
    @Test
    public void enumerateProfilesTest() throws ApiException {
        Integer offset = null;
        Integer limit = null;
        EnumerateBillingProfileModel response = api.enumerateProfiles(offset, limit);
     ...
     */
    @Test
    public void retrieveProfileTest() throws ApiException {
        String id = null;
        BillingProfileModel response = api.retrieveProfile(id);
