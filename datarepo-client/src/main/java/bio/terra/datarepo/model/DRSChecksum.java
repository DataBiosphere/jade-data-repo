...
public class DRSChecksum {
  ...
  public DRSChecksum checksum(String checksum) {
  ...
  **/
  ...
  public DRSChecksum type(String type) {
    this.type = type;
    return this;
  }

   /**
   * The digest method used to create the checksum. If left unspecified md5 will be assumed.  possible values: md5                # most blob stores provide a checksum using this etag               # multipart uploads to blob stores sha256 sha512
   * @return type
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DRSChecksum drSChecksum = (DRSChecksum) o;
    return Objects.equals(this.checksum, drSChecksum.checksum) &&
        Objects.equals(this.type, drSChecksum.type);
  }
