...
public enum ConfigEnum {
    ...
    FILE_INGEST_SHARED_LOCK_RETRY_FAULT,
    FILE_INGEST_SHARED_LOCK_FATAL_FAULT,
    FILE_INGEST_SHARED_UNLOCK_RETRY_FAULT,
    FILE_INGEST_SHARED_UNLOCK_FATAL_FAULT,
    FILE_INGEST_EXCLUSIVE_LOCK_RETRY_FAULT,
    FILE_INGEST_EXCLUSIVE_LOCK_FATAL_FAULT,
    FILE_INGEST_EXCLUSIVE_UNLOCK_RETRY_FAULT,
    FILE_INGEST_EXCLUSIVE_UNLOCK_FATAL_FAULT,
