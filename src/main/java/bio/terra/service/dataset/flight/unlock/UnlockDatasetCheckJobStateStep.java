        ...
        return new StepResult(
            ...
            new DatasetLockException(
                "Locking flight "
                    ...
                    + " has state "
                    + status.name()
                    + ". Unlocking a running flight could have unintended consequences. Please proceed with unlock with caution (You still still unlock by setting failOnRunningJob to false)."));
      default:
