 ...
 */
@ApiModel(description = "Returns the state of the object of the deletion ")
...
public class DeleteResponseModel {
  ...
  public enum ObjectStateEnum {
    ...
    @JsonCreator
    public static ObjectStateEnum fromValue(String text) {
      for (ObjectStateEnum b : ObjectStateEnum.values()) {
  ...
  private ObjectStateEnum objectState = null;

  public DeleteResponseModel objectState(ObjectStateEnum objectState) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DeleteResponseModel deleteResponseModel = (DeleteResponseModel) o;
    return Objects.equals(this.objectState, deleteResponseModel.objectState);
  }

  @Override
  public int hashCode() {
    return Objects.hash(objectState);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteResponseModel {\n");
