...
public final class ToApiConversionUtils {
   ...
   */
  public static Cohort toApiObject(bio.terra.tanagra.service.artifact.Cohort cohort) {
    return new Cohort()
  ...
  private static CriteriaGroup toApiObject(
      bio.terra.tanagra.service.artifact.CriteriaGroup criteriaGroup) {
  ...
  public static Criteria toApiObject(bio.terra.tanagra.service.artifact.Criteria criteria) {
    return new Criteria()
