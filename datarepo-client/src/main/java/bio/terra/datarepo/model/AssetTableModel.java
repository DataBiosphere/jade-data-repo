 ...
 */
@ApiModel(description = "Used in the asset definition to describe a table that is included in the asset. This is used to define the view of the asset table in the snapshot. Columns can be an empty array indicating that all columns should be included. ")
...
public class AssetTableModel {
  ...
  public AssetTableModel name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public AssetTableModel columns(List<String> columns) {
    this.columns = columns;
    return this;
  }

  public AssetTableModel addColumnsItem(String columnsItem) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    AssetTableModel assetTableModel = (AssetTableModel) o;
    return Objects.equals(this.name, assetTableModel.name) &&
        Objects.equals(this.columns, assetTableModel.columns);
  }
  ...
  public String toString() {
    ...
    sb.append("class AssetTableModel {\n");
