 ...
 */
@ApiModel(description = "SnapshotSourceModel returns data about the source for an existing snapshot ")
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2020-09-25T14:51:02.312-04:00")
public class SnapshotSourceModel {
  @JsonProperty("dataset")
  private DatasetSummaryModel dataset = null;

  @JsonProperty("asset")
  private String asset = null;

  public SnapshotSourceModel dataset(DatasetSummaryModel dataset) {
  ...
  **/
  ...
  public DatasetSummaryModel getDataset() {
    return dataset;
  }

  public void setDataset(DatasetSummaryModel dataset) {
    this.dataset = dataset;
  }

  public SnapshotSourceModel asset(String asset) {
    this.asset = asset;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    SnapshotSourceModel snapshotSourceModel = (SnapshotSourceModel) o;
    return Objects.equals(this.dataset, snapshotSourceModel.dataset) &&
        Objects.equals(this.asset, snapshotSourceModel.asset);
  }

  @Override
  public int hashCode() {
    return Objects.hash(dataset, asset);
  }
  ...
  public String toString() {
    ...
    sb.append("class SnapshotSourceModel {\n");
