 ...
 */
@Component
public class DrDatasetRequestValidator implements Validator {
    ...
    private void validateDatasetName(String datasetName, Errors errors) {
        if (datasetName == null) {
            errors.rejectValue("name", "DrDatasetNameMissing");
        } else if (!ValidationUtils.isValidName(datasetName)) {
            errors.rejectValue("name", "DrDatasetNameInvalid",
    ...
    private void validateSchema(DrDatasetSpecificationModel schema, Errors errors) {
    ...
    public void validate(@NotNull Object target, Errors errors) {
        if (target != null && target instanceof DrDatasetRequestModel) {
            DrDatasetRequestModel datasetRequest = (DrDatasetRequestModel) target;
            validateDatasetName(datasetRequest.getName(), errors);
            DrDatasetSpecificationModel schema = datasetRequest.getSchema();
            if (schema != null) {
