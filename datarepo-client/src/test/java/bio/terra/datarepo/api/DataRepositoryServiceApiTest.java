...
public class DataRepositoryServiceApiTest {
     ...
     */
    @Test
    public void getAccessURLTest() throws ApiException {
        String objectId = null;
        String accessId = null;
        DRSAccessURL response = api.getAccessURL(objectId, accessId);
    ...
    public void getObjectTest() throws ApiException {
        String objectId = null;
        Boolean expand = null;
        DRSObject response = api.getObject(objectId, expand);
    ...
    public void getServiceInfoTest() throws ApiException {
        DRSServiceInfo response = api.getServiceInfo();
