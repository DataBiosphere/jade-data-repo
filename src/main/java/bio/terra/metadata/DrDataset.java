...
public class DrDataset extends DrDatasetSummary {

    private List<Table> tables = Collections.emptyList();
    private List<DrDatasetRelationship> relationships = Collections.emptyList();
    private List<AssetSpecification> assetSpecifications = Collections.emptyList();

    public DrDataset() {
    }

    public DrDataset(DrDatasetSummary summary) {
        super(summary);
    }
    ...
    public DrDataset tables(List<Table> tables) {
        this.tables = Collections.unmodifiableList(tables);
        return this;
    }

    public List<DrDatasetRelationship> getRelationships() {
        return relationships;
    }

    public DrDataset relationships(List<DrDatasetRelationship> relationships) {
    ...
    public DrDataset assetSpecifications(List<AssetSpecification> assetSpecifications) {
    ...
    public Map<UUID, DrDatasetRelationship> getRelationshipsById() {
        Map<UUID, DrDatasetRelationship> relationships = new HashMap<>();
