...
public class DatasetStorageAccountDao {
    ...
    private static final String sqlCreateLink = "INSERT INTO dataset_storage_account " +
    ...
    private static final String sqlIncrementCount = "UPDATE dataset_storage_account " +
        " SET successful_ingests = successful_ingests + 1" + whereClause;

    private static final String sqlDecrementCount = "UPDATE dataset_storage_account " +
        " SET successful_ingests = successful_ingests - 1" + whereClause;
    ...
    private static final String sqlDeleteLink =
        "DELETE FROM dataset_storage_account" + whereClause;
    ...
    public void createDatasetStorageAccountLink(UUID datasetId,
                                                UUID storageAccountResourceId,
                                                boolean createdDuringFileIngest) {
        if (datasetStorageAccountLinkExists(datasetId, storageAccountResourceId)) {
            ...
            datasetStorageAccountLinkUpdate(sqlCreateLink, datasetId, storageAccountResourceId, initialValue);
        }
    }
    ...
    public List<UUID> getStorageAccountResourceIdForDatasetId(UUID datasetId) {
        MapSqlParameterSource params = new MapSqlParameterSource()
            .addValue("dataset_id", datasetId);
        return jdbcTemplate.query(sqlGetStorageAccountResourceId, params,
            new UuidMapper("storage_account_resource_id"));
    }
    ...
    private void datasetStorageAccountLinkUpdate(String sql,
                                                 UUID datasetId,
                                                 UUID storageAccountResourceId,
