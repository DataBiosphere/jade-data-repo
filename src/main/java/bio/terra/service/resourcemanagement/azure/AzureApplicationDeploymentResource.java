...
public class AzureApplicationDeploymentResource {
    ...
    private AzureStorageAccountSkuType storageAccountSkuType; // storage type to use when creating storage account
    ...
    public AzureApplicationDeploymentResource azureApplicationDeploymentId(String azureApplicationDeploymentId) {
    ...
    public AzureApplicationDeploymentResource azureApplicationDeploymentName(String azureApplicationDeploymentName) {
    ...
    public AzureApplicationDeploymentResource azureSynapseWorkspaceName(String azureSynapseWorkspaceName) {
    ...
    public AzureApplicationDeploymentResource storageAccountSkuType(AzureStorageAccountSkuType storageAccountSkuType) {
