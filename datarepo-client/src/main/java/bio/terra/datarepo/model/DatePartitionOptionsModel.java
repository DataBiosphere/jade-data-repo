 ...
 */
@ApiModel(description = "Describes how a date partition should be configured.")
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2020-09-25T14:51:02.312-04:00")
public class DatePartitionOptionsModel {
  @JsonProperty("column")
  private String column = null;

  public DatePartitionOptionsModel column(String column) {
    this.column = column;
    return this;
  }

   /**
   * The DATE or TIMESTAMP column in the table to partition on, or &#39;datarepo_ingest_date&#39; to partition by ingest time. 
   * @return column
  **/
  @ApiModelProperty(required = true, value = "The DATE or TIMESTAMP column in the table to partition on, or 'datarepo_ingest_date' to partition by ingest time. ")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DatePartitionOptionsModel datePartitionOptionsModel = (DatePartitionOptionsModel) o;
    return Objects.equals(this.column, datePartitionOptionsModel.column);
  }
  ...
  public String toString() {
    ...
    sb.append("class DatePartitionOptionsModel {\n");
