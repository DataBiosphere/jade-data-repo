...
class TestRunner {
  ...
  List<UserJourneyResult> executeTestConfiguration() throws InterruptedException, IOException {
    // deploy new DR Manager with Helm and set any Kubernetes properties specified by the test
    // configuration
  ...
  void setupClusterAndDeploy() {
    // TODO: modify Helm template with DR Manager property overrides, deploy, modify any other
    // Kubernetes settings
  }
