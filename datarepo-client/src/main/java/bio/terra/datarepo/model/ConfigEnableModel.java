 ...
 */
@ApiModel(description = "Control whether a fault is enabled")
...
public class ConfigEnableModel {
  ...
  public ConfigEnableModel enabled(Boolean enabled) {
    this.enabled = enabled;
    return this;
  }

   /**
   * whether to enable (default) or disable the fault
   * @return enabled
  **/
  @ApiModelProperty(value = "whether to enable (default) or disable the fault")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ConfigEnableModel configEnableModel = (ConfigEnableModel) o;
    return Objects.equals(this.enabled, configEnableModel.enabled);
  }
  ...
  public String toString() {
    ...
    sb.append("class ConfigEnableModel {\n");
