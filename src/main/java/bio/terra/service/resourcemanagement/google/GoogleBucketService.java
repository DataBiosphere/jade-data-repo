...
public class GoogleBucketService {
    ...
    /**
     * Fetch metadata for an existing bucket_resource
    ...
    public GoogleBucketResource getOrCreateBucket(String bucketName,
        ...
        boolean allowReuseExistingBuckets = configService.getParameterValue(ConfigEnum.ALLOW_REUSE_EXISTING_BUCKETS);
        ...
        GoogleBucketResource googleBucketResource = resourceDao.getBucket(bucketName, projectResource.getId());
    ...
    private GoogleBucketResource createCloudBucket(GoogleBucketResource bucketResource, String flightId) {
    ...
    private Bucket newCloudBucket(GoogleBucketResource bucketResource) {
        ...
        BucketInfo bucketInfo = BucketInfo.newBuilder(bucketName)
            ...
            .setLocation(bucketResource.getRegion().getBucketRegion().toString())
