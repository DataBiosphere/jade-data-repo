 ...
 */
@ApiModel(description = "The total number of billing profiles available and a page of profiles ")
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2020-09-25T14:51:02.312-04:00")
public class EnumerateBillingProfileModel {
  @JsonProperty("total")
  private Integer total = null;

  @JsonProperty("items")
  private List<BillingProfileModel> items = null;

  public EnumerateBillingProfileModel total(Integer total) {
    this.total = total;
    return this;
  }

   /**
   * Total number of billing profiles
   * @return total
  **/
  @ApiModelProperty(value = "Total number of billing profiles")
  ...
  public EnumerateBillingProfileModel items(List<BillingProfileModel> items) {
    this.items = items;
    return this;
  }

  public EnumerateBillingProfileModel addItemsItem(BillingProfileModel itemsItem) {
    if (this.items == null) {
  ...
  **/
  ...
  public List<BillingProfileModel> getItems() {
    return items;
  }

  public void setItems(List<BillingProfileModel> items) {
    this.items = items;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EnumerateBillingProfileModel enumerateBillingProfileModel = (EnumerateBillingProfileModel) o;
    return Objects.equals(this.total, enumerateBillingProfileModel.total) &&
        Objects.equals(this.items, enumerateBillingProfileModel.items);
  }
  ...
  public String toString() {
    ...
    sb.append("class EnumerateBillingProfileModel {\n");
