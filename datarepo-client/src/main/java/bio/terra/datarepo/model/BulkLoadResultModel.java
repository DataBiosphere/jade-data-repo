...
public class BulkLoadResultModel {
  ...
  @JsonProperty("succeededFiles")
  private Integer succeededFiles = null;

  @JsonProperty("failedFiles")
  private Integer failedFiles = null;

  @JsonProperty("notTriedFiles")
  private Integer notTriedFiles = null;

  public BulkLoadResultModel loadTag(String loadTag) {
  ...
  **/
  ...
  public BulkLoadResultModel jobId(String jobId) {
    this.jobId = jobId;
    return this;
  }
  ...
  **/
  ...
  public BulkLoadResultModel totalFiles(Integer totalFiles) {
  ...
  **/
  ...
  public BulkLoadResultModel succeededFiles(Integer succeededFiles) {
  ...
  **/
  ...
  public BulkLoadResultModel failedFiles(Integer failedFiles) {
  ...
  **/
  ...
  public BulkLoadResultModel notTriedFiles(Integer notTriedFiles) {
    this.notTriedFiles = notTriedFiles;
    return this;
  }

   /**
   * Get notTriedFiles
   * @return notTriedFiles
  **/
  @ApiModelProperty(value = "")
  public Integer getNotTriedFiles() {
    return notTriedFiles;
  }

  public void setNotTriedFiles(Integer notTriedFiles) {
    this.notTriedFiles = notTriedFiles;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    BulkLoadResultModel bulkLoadResultModel = (BulkLoadResultModel) o;
    return Objects.equals(this.loadTag, bulkLoadResultModel.loadTag) &&
        Objects.equals(this.jobId, bulkLoadResultModel.jobId) &&
        Objects.equals(this.totalFiles, bulkLoadResultModel.totalFiles) &&
        Objects.equals(this.succeededFiles, bulkLoadResultModel.succeededFiles) &&
        Objects.equals(this.failedFiles, bulkLoadResultModel.failedFiles) &&
        Objects.equals(this.notTriedFiles, bulkLoadResultModel.notTriedFiles);
  }

  @Override
  public int hashCode() {
    return Objects.hash(loadTag, jobId, totalFiles, succeededFiles, failedFiles, notTriedFiles);
  }
  ...
  public String toString() {
    ...
    sb.append("class BulkLoadResultModel {\n");
    ...
    sb.append("    succeededFiles: ").append(toIndentedString(succeededFiles)).append("\n");
    sb.append("    failedFiles: ").append(toIndentedString(failedFiles)).append("\n");
    sb.append("    notTriedFiles: ").append(toIndentedString(notTriedFiles)).append("\n");
    sb.append("}");
    return sb.toString();
  }
