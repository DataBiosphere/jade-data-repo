 ...
 */
@ApiModel(description = "A specification of a table, columns, and row ids to go into a snapshot. ")
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2020-09-25T14:51:02.312-04:00")
public class SnapshotRequestRowIdTableModel {
  ...
  public SnapshotRequestRowIdTableModel tableName(String tableName) {
  ...
  **/
  ...
  public SnapshotRequestRowIdTableModel columns(List<String> columns) {
    this.columns = columns;
    return this;
  }

  public SnapshotRequestRowIdTableModel addColumnsItem(String columnsItem) {
  ...
  **/
  ...
  public SnapshotRequestRowIdTableModel rowIds(List<String> rowIds) {
    this.rowIds = rowIds;
    return this;
  }

  public SnapshotRequestRowIdTableModel addRowIdsItem(String rowIdsItem) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    SnapshotRequestRowIdTableModel snapshotRequestRowIdTableModel = (SnapshotRequestRowIdTableModel) o;
    return Objects.equals(this.tableName, snapshotRequestRowIdTableModel.tableName) &&
        Objects.equals(this.columns, snapshotRequestRowIdTableModel.columns) &&
        Objects.equals(this.rowIds, snapshotRequestRowIdTableModel.rowIds);
  }

  @Override
  public int hashCode() {
    return Objects.hash(tableName, columns, rowIds);
  }
  ...
  public String toString() {
    ...
    sb.append("class SnapshotRequestRowIdTableModel {\n");
