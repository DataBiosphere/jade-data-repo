...
public class EncodeFile {
    ...
    private Instant date_file_created;
    ...
    public EncodeFile file_id(String file_id) {
    ...
    public EncodeFile assay_type(String assay_type) {
    ...
    public EncodeFile biosamples(String biosamples) {
    ...
    public EncodeFile biosample_term_id(String biosample_term_id) {
    ...
    public EncodeFile biosample_type(String biosample_type) {
    ...
    public EncodeFile cell_type(String cell_type) {
    ...
    public EncodeFile data_quality_category(String data_quality_category) {
    ...
    public EncodeFile data_source(String data_source) {
    ...
    public EncodeFile data_type(String data_type) {
        this.data_type = data_type;
        return this;
    }

    public Instant getDate_file_created() {
        return date_file_created;
    }

    public EncodeFile date_file_created(Instant date_file_created) {
    ...
    public EncodeFile derived_from_exp(String derived_from_exp) {
    ...
    public EncodeFile derived_from_ref(String derived_from_ref) {
    ...
    public EncodeFile dna_library_ids(String dna_library_ids) {
    ...
    public EncodeFile donor_id(String donor_id) {
    ...
    public EncodeFile experiments(String experiments) {
    ...
    public EncodeFile file_available_in_gcs(boolean file_available_in_gcs) {
    ...
    public EncodeFile file_format(String file_format) {
    ...
    public EncodeFile file_format_subtype(String file_format_subtype) {
    ...
    public EncodeFile file_ref(String file_ref) {
    ...
    public EncodeFile file_index_ref(String file_index_ref) {
    ...
    public EncodeFile file_size_mb(long file_size_mb) {
    ...
    public EncodeFile labs_generating_data(String labs_generating_data) {
    ...
    public EncodeFile md5sum(String md5sum) {
        this.md5sum = md5sum;
        return this;
    }
    ...
    public EncodeFile more_info(String more_info) {
    ...
    public EncodeFile paired_end_sequencing(boolean paired_end_sequencing) {
    ...
    public EncodeFile percent_aligned_reads(double percent_aligned_reads) {
    ...
    public EncodeFile percent_duplicated_reads(double percent_duplicated_reads) {
    ...
    public EncodeFile read_count(long read_count) {
    ...
    public EncodeFile read_length(long read_length) {
    ...
    public EncodeFile reference_genome_assembly(String reference_genome_assembly) {
    ...
    public EncodeFile replicate_ids(String replicate_ids) {
    ...
    public EncodeFile target_of_assay(String target_of_assay) {
