 ...
 */
@ApiModel(description = "one column of a table")
...
public class ColumnModel {
  ...
  @JsonProperty("array_of")
  private Boolean arrayOf = false;
  ...
  **/
  ...
  public ColumnModel datatype(String datatype) {
  ...
  **/
  ...
  public ColumnModel arrayOf(Boolean arrayOf) {
    this.arrayOf = arrayOf;
    return this;
  }

   /**
   * if true, make this column an array of type datatype.
   * @return arrayOf
  **/
  @ApiModelProperty(value = "if true, make this column an array of type datatype.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.name, columnModel.name) &&
        Objects.equals(this.datatype, columnModel.datatype) &&
        Objects.equals(this.arrayOf, columnModel.arrayOf);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, datatype, arrayOf);
  }
  ...
  public String toString() {
    ...
    sb.append("    arrayOf: ").append(toIndentedString(arrayOf)).append("\n");
    sb.append("}");
    return sb.toString();
  }
