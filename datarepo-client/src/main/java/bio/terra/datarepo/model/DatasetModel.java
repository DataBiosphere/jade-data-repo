 ...
 */
@ApiModel(description = "Complete definition of a dataset. ")
...
public class DatasetModel {
  ...
  @JsonProperty("additionalProfileIds")
  private List<String> additionalProfileIds = null;

  @JsonProperty("defaultSnapshotId")
  private String defaultSnapshotId = null;

  @JsonProperty("schema")
  private DatasetSpecificationModel schema = null;
  ...
  **/
  ...
  public DatasetModel defaultProfileId(String defaultProfileId) {
    this.defaultProfileId = defaultProfileId;
    return this;
  }

   /**
   * This is the profile id used for core dataset resources
   * @return defaultProfileId
  **/
  @ApiModelProperty(value = "This is the profile id used for core dataset resources")
  ...
  public DatasetModel dataProject(String dataProject) {
   ...
   * @return dataProject
  **/
  @ApiModelProperty(value = "Project id of the project where tabular data in BigQuery lives")
  ...
  public DatasetModel additionalProfileIds(List<String> additionalProfileIds) {
    this.additionalProfileIds = additionalProfileIds;
    return this;
  }

  public DatasetModel addAdditionalProfileIdsItem(String additionalProfileIdsItem) {
    if (this.additionalProfileIds == null) {
      this.additionalProfileIds = new ArrayList<>();
    }
    this.additionalProfileIds.add(additionalProfileIdsItem);
    return this;
  }

   /**
   * Additional profile ids to be used for this dataset
   * @return additionalProfileIds
  **/
  @ApiModelProperty(value = "Additional profile ids to be used for this dataset")
  public List<String> getAdditionalProfileIds() {
    return additionalProfileIds;
  }

  public void setAdditionalProfileIds(List<String> additionalProfileIds) {
    this.additionalProfileIds = additionalProfileIds;
  }

  public DatasetModel defaultSnapshotId(String defaultSnapshotId) {
    this.defaultSnapshotId = defaultSnapshotId;
    return this;
  }

   /**
   * Id of the auto-generated default passthru snapshot
   * @return defaultSnapshotId
  **/
  @ApiModelProperty(value = "Id of the auto-generated default passthru snapshot")
  public String getDefaultSnapshotId() {
    return defaultSnapshotId;
  }

  public void setDefaultSnapshotId(String defaultSnapshotId) {
    this.defaultSnapshotId = defaultSnapshotId;
  }

  public DatasetModel schema(DatasetSpecificationModel schema) {
    this.schema = schema;
    return this;
  }
  ...
  **/
  @ApiModelProperty(value = "")
  public DatasetSpecificationModel getSchema() {
    return schema;
  }

  public void setSchema(DatasetSpecificationModel schema) {
    this.schema = schema;
  }
   ...
   * @return createdDate
  **/
  @ApiModelProperty(value = "Date the dataset was created")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, datasetModel.id) &&
        ...
        Objects.equals(this.defaultProfileId, datasetModel.defaultProfileId) &&
        Objects.equals(this.dataProject, datasetModel.dataProject) &&
        Objects.equals(this.additionalProfileIds, datasetModel.additionalProfileIds) &&
        Objects.equals(this.defaultSnapshotId, datasetModel.defaultSnapshotId) &&
        Objects.equals(this.schema, datasetModel.schema) &&
        Objects.equals(this.createdDate, datasetModel.createdDate);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, description, defaultProfileId, dataProject, additionalProfileIds, defaultSnapshotId, schema, createdDate);
  }
  ...
  public String toString() {
    ...
    sb.append("    additionalProfileIds: ").append(toIndentedString(additionalProfileIds)).append("\n");
    sb.append("    defaultSnapshotId: ").append(toIndentedString(defaultSnapshotId)).append("\n");
