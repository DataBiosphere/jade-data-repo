package bio.terra.datarepo.client;
...
import bio.terra.datarepo.client.auth.Authentication;
import bio.terra.datarepo.client.auth.HttpBasicAuth;
import bio.terra.datarepo.client.auth.ApiKeyAuth;
...
public class ApiClient {
  ...
  public ApiClient() {
    ...
    authentications.put("authToken", new ApiKeyAuth("header", "Authorization"));
    authentications.put("googleoauth", new OAuth());
