...
class TestRunner {
    ...
    List<UserJourneyResult> executeTestConfiguration() throws InterruptedException, IOException {
        // deploy new DR Manager with Helm and set any Kubernetes properties specified by the test configuration
        setupClusterAndDeploy();
        ...
        for (int ctr = 0; ctr < scripts.size(); ctr++) {
            ...
            ApiClient apiClient = apiClientList.get(ctr % apiClientList.size());
    ...
    void setupClusterAndDeploy() {
        // TODO: modify Helm template with DR Manager property overrides, deploy, modify any other Kubernetes settings
    }
    ...
    void cleanupTestData() {
        // TODO: cleanup any cloud resources generated by the test
    }
